...
import Web.Control.EmployeControl;
...
public class Employe_CL implements Initializable{
    @FXML
    private Label lb;
     @FXML
    ...
    EmployeControl pc = new EmployeControl();
    String typeValue[] = {"Administrador", "Limpieza", "Asistente", "Caja"};
    int ID;
